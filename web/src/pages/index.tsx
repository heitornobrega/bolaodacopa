...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28">
      <main>
        <Image src={logoImg} alt="NLW logo" quality={100} />
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2 text-gray-100">
          <input
            className="flex-1 px-6 py-4 rounded bg-gray-800 border border-y-gray-600 text-sm"
            type="text"
            required
      ...
      <Image
        src={appPreviewImg}
        alt="ois celulares exibindo uma pŕevia da aplicação"
        quality={100}
      />
    </div>
  );
